...
```text
POST https://sharebin.lovable.app/api/v1/create
Headers: {'Content-Type': 'application/json', 'Authorization': 'Bearer ts_lbhGns25tonmHgO28aV0D2vzeVnEfSUO'}
Body: {"content": "Hello from python script", "title": "From Python", "syntax": "plaintext", "expiration": "never"}
```
...
<html lang="en">
  <head>
    ...
    <title>Pastely - Share Text Instantly</title>
    <meta name="description" content="Pastely - The fastest way to share text, code snippets, and markdown online. Free, open source, with syntax highlighting and privacy features." />
    <meta name="author" content="Pastely" />

    <meta property="og:title" content="Pastely - Share Text Instantly" />
    <meta property="og:description" content="The fastest way to share text, code snippets, and markdown online." />
    <meta property="og:type" content="website" />
    <meta property="og:image" content="https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/6dc25a7e-89af-4de3-8b69-5ceeabc7dcba/id-preview-98af022a--912671e2-47c3-46ae-9d24-15248bb522c1.lovable.app-1767722454605.png" />

    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:site" content="@Pastely" />
    <meta name="twitter:image" content="https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/6dc25a7e-89af-4de3-8b69-5ceeabc7dcba/id-preview-98af022a--912671e2-47c3-46ae-9d24-15248bb522c1.lovable.app-1767722454605.png" />
    <script type="module" crossorigin src="/assets/index-XDIpWdBA.js"></script>
    <link rel="stylesheet" crossorigin href="/assets/index-CHDBq3b4.css">
...
<script defer src="https://sharebin.lovable.app/~flock.js" data-proxy-url="https://sharebin.lovable.app/~api/analytics"></script></head>
...
<aside 
	...
	<a 
		...
		target="_blank" 
		href="https://lovable.dev/projects/912671e2-47c3-46ae-9d24-15248bb522c1?utm_source=lovable-badge"
		rel="noopener"
		aria-label="Edit with Lovable">
...
```text
GET https://sharebin.lovable.app/api/v1/get?id=a65ce07e
```
...
```text
GET https://sharebin.lovable.app/api/v1/raw?id=a65ce07e
```
...
```text
GET https://sharebin.lovable.app/api/v1/list
Headers: {'Authorization': 'Bearer ts_lbhGns25tonmHgO28aV0D2vzeVnEfSUO'}
```
...
```text
DELETE https://sharebin.lovable.app/api/v1/delete?id=a65ce07e
Headers: {'Authorization': 'Bearer ts_lbhGns25tonmHgO28aV0D2vzeVnEfSUO'}
```
